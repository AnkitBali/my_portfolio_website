...
import { Box, Image, Link, IconButton, CloseButton, HStack } from "@chakra-ui/react";
      ...
      >
        ...
        >
          ...
          <Link
            ...
            _hover={{ color: "gray.600" }}
            mx={4} 
            href="/#techstack" >Tech Stack</Link>
          <Link
            fontWeight="bold"
            color="gray.800"
            _hover={{ color: "gray.600" }}
