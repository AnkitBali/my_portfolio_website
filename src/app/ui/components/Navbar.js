    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    <Link href="/" fontWeight={"bold"} color="gray.800" mr="50px" _hover={{ color: "black" }}>
                        Home
                    </Link>
                    <Link
                    href="/#techstack" 
                    
                     fontWeight={"bold"} color="gray.800" mr="50px" _hover={{ color: "black" }}>
                        Tech Stack
                    </Link>
                    {/* <ScrollLink
                        to="projects"  // This should match the id of the element you want to scroll to
                        smooth={true}
                        duration={500} // Adjust the duration as needed
                        // offset={-70}   // Adjust the offset if necessary, this will bring the target to the top of the screen
                        spy={true}
                        > */}
                    <Link href="/#projects" fontWeight={"bold"} color="gray.800" mr="50px" _hover={{ color: "black" }}>
                        Projects
                    </Link>
                    {/* </ScrollLink> */}
                    <Link href="/about" fontWeight={"bold"} color="gray.800" mr="50px" _hover={{ color: "black" }}>
                        About
                    </Link>
                    
                    <Link href="/contact" fontWeight={"bold"} color="gray.800" mr="50px" _hover={{ color: "black" }}>
                        Contact
                    </Link>
                    <Link
                        // width={'0px'}
